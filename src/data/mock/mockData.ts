...
export const mockSignage: DigitalSignage[] = [
  { id: 'DS-401', floorId: 'floor-0', blockId: 'block-a', location: 'Entrance East A', status: 'online', contentTitle: 'WELCOME', template: 'Standard Welcome (v4.2)', brightness: 85, temperatureC: 32.4, lastSync: '2m ago', x: 250, y: 138, orientation: 'vertical' },
  { id: 'DS-405', floorId: 'floor-0', blockId: 'block-a', location: 'Kiosk Main', status: 'online', contentTitle: 'STARBUCKS CAMPAIGN', template: 'Partner Campaign (v1.8)', brightness: 78, temperatureC: 31.8, lastSync: '15s ago', x: 500, y: 300, orientation: 'horizontal' },
  { id: 'DS-410', floorId: 'floor-0', blockId: 'block-c', location: 'Elevator Bank', status: 'offline', contentTitle: 'OFFLINE', template: 'Diagnostics', brightness: 0, temperatureC: 29.1, lastSync: '4h ago', x: 750, y: 138, orientation: 'vertical' },
  { id: 'DS-411', floorId: 'floor-0', blockId: 'block-b', location: 'Ground Central Hall', status: 'online', contentTitle: 'SHOPPING GUIDE', template: 'Wayfinding (v2.4)', brightness: 79, temperatureC: 31.0, lastSync: '48s ago', x: 454, y: 248, orientation: 'vertical' },
  { id: 'DS-412', floorId: 'floor-0', blockId: 'block-c', location: 'Valet Front Lane', status: 'online', contentTitle: 'VALET CHECK-IN', template: 'Valet Direction (v1.6)', brightness: 82, temperatureC: 31.4, lastSync: '1m ago', x: 874, y: 300, orientation: 'vertical' },
  { id: 'DS-501', floorId: 'floor-b1', blockId: 'block-a', location: 'Ramp Down', status: 'online', contentTitle: 'ATASUN CAMPAIGN', template: 'Partner Campaign (v2.0)', brightness: 80, temperatureC: 33.0, lastSync: '4m ago', x: 250, y: 434, orientation: 'vertical' },
  { id: 'DS-502', floorId: 'floor-b1', blockId: 'block-b', location: 'Central Pillar', status: 'online', contentTitle: 'ADIDAS OFFER', template: 'Retail Offer (v3.1)', brightness: 88, temperatureC: 32.7, lastSync: 'Just now', x: 750, y: 434, orientation: 'vertical' },
  { id: 'DS-503', floorId: 'floor-b1', blockId: 'block-d', location: 'Block D Exit Lane', status: 'online', contentTitle: 'PAYMENT KIOSK', template: 'Wayfinding (v2.1)', brightness: 74, temperatureC: 31.1, lastSync: '52s ago', x: 316, y: 478, orientation: 'horizontal' },
  { id: 'DS-504', floorId: 'floor-b1', blockId: 'block-c', location: 'Block C South Edge', status: 'online', contentTitle: 'FIND YOUR CAR', template: 'Wayfinding (v2.4)', brightness: 77, temperatureC: 30.9, lastSync: '39s ago', x: 648, y: 478, orientation: 'horizontal' },
  { id: 'DS-505', floorId: 'floor-b1', blockId: 'block-b', location: 'Block B North Hall', status: 'online', contentTitle: 'EXIT LEFT', template: 'Direction (v1.9)', brightness: 75, temperatureC: 31.3, lastSync: '2m ago', x: 414, y: 248, orientation: 'vertical' },
  { id: 'DS-402', floorId: 'floor-b2', blockId: 'block-a', location: 'Block A Entry', status: 'online', contentTitle: 'WELCOME TO EMAAR SQUARE AVM', template: 'Standard Welcome (v4.2)', brightness: 85, temperatureC: 32.4, lastSync: '14:20:05', x: 250, y: 138, orientation: 'vertical' },
  { id: 'DS-603', floorId: 'floor-b2', blockId: 'block-c', location: 'Center Junction', status: 'online', contentTitle: 'FIND YOUR CAR', template: 'Wayfinding (v2.3)', brightness: 81, temperatureC: 31.2, lastSync: '31s ago', x: 500, y: 300, orientation: 'horizontal' },
  { id: 'DS-604', floorId: 'floor-b2', blockId: 'block-f', location: 'Exit Portal B', status: 'online', contentTitle: 'VALET SERVICE', template: 'Valet Direction (v1.5)', brightness: 72, temperatureC: 30.2, lastSync: '1h ago', x: 750, y: 300, orientation: 'vertical' },
  { id: 'DS-605', floorId: 'floor-b2', blockId: 'block-e', location: 'VIP Corridor', status: 'online', contentTitle: 'VIP ACCESS', template: 'Vip Guidance (v1.1)', brightness: 76, temperatureC: 30.8, lastSync: '2m ago', x: 500, y: 432, orientation: 'horizontal' },
  { id: 'DS-606', floorId: 'floor-b2', blockId: 'block-f', location: 'North Exit Lane', status: 'offline', contentTitle: 'SERVICE CHECK', template: 'Diagnostics', brightness: 0, temperatureC: 28.9, lastSync: '3h ago', x: 850, y: 182, orientation: 'vertical' },
  { id: 'DS-607', floorId: 'floor-b2', blockId: 'block-b', location: 'Block B North Hall', status: 'online', contentTitle: 'LEVEL -2 GUIDE', template: 'Wayfinding (v2.5)', brightness: 78, temperatureC: 30.7, lastSync: '44s ago', x: 370, y: 248, orientation: 'vertical' },
  { id: 'DS-608', floorId: 'floor-b2', blockId: 'block-e', location: 'VIP South Exit', status: 'online', contentTitle: 'VIP EXIT', template: 'Vip Guidance (v1.2)', brightness: 80, temperatureC: 31.0, lastSync: '1m ago', x: 500, y: 474, orientation: 'horizontal' },
]
